...
INSERT INTO gifts (gift, giver, value, previously_regifted)
VALUES
('peach candle', 'Santa', '99', TRUE),
('cinnamon candle', 'Mrs.Clause', '19', TRUE),
('Moss', 'Rudolf', '30', FALSE),
('Orchid', 'Elf on the Shelf', '150', TRUE),
('mango lassi', 'The Boss', '8', FALSE)
;
...
--
SELECT * FROM gift WHERE gift ILIKE '%candle%';
...
SELECT * FROM gifts WHERE giver = 'Santa' OR value is greater than 30;
