...
DROP DATABASE IF EXISTS regifter; -- drop the database if it exists
CREATE DATABASE regifter; -- create the database
\c regifter -- connect to the database
...
INSERT INTO gifts (gift, giver, value, previously_regifted)
VALUES
('peach blossom candle', 'Santa', '99', TRUE),
('cinnamon apple candle', 'Nick fury', '19', TRUE),
('pine cone soap', 'Rudolf', '290', FALSE),
('potpurri bouquet', 'Elf on the Shelf', '39', TRUE),
('mango candle with flaxseed', 'Saint Nicholas', '49', FALSE)
;
...
--
SELECT * FROM gifts WHERE id = 2; -- 2nd item is now 2999
--
