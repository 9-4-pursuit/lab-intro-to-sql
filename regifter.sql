...
VALUES
('orange candle', 'Santa', '99', TRUE),
('apple cinnamon candle', 'Mrs Clause', '19', TRUE),
('Moss', 'Rudolf', '29', FALSE),
('Orchid', 'Elf on the Shelf', '149', TRUE),
...
-- 
SELECT COUNT(gift) FROM gifts WHERE gift ILKIE '%candle%';
