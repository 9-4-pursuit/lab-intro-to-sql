...
INSERT INTO gifts (gift, giver, value, previously_regifted)
VALUES
('eucalyptus candle', 'Lamar', '109', FALSE),
('diamond ring', 'Lamar', '34000', FALSE),
('soap on a rope', 'Terra-Tory', '18', FALSE),
('Shein Sunglasses', 'Elf on the Shelf', '5', TRUE),
('Chloe Purse Strap', 'BIANCA!', '349', FALSE)
;
SELECT * FROM gifts;
--
