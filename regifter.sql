...
INSERT INTO gifts (gift, giver, value, previously_regifted)
VALUES
('cherry candle', 'Santa', '99', TRUE),
('chocolate candle', 'Nick', '20', TRUE),
('blossom', 'Rudolf', '20', FALSE),
('chicken pot pie', ' Someone on the Shelf', '40', TRUE),
('mango chile candle', 'The Manager', '50', FALSE);
