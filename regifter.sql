...
VALUES
('snow', 'Santa', '2', TRUE),
('peppermint', 'Nick', '7', TRUE),
('red nose', 'Rudolf', '100', FALSE),
('charcuterie', 'Elf on the Shelf', '23', TRUE),
('reindeer poop', 'The Boss', '10', FALSE);

SELECT * FROM gifts;
--
\echo Query for gifts with a price greater than or equal to 20
--
SELECT gift, value FROM gifts WHERE value >= 20;
